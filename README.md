...
> 6 legs, 18 servos, ESP32, ESP-IDF, FreeRTOS, direct PWM.

![Hexapod V1](docs/hexapod_v1_cleaned.png)

The distributed RS485/RP2040 leg-controller generation of this project has moved to a separate repository: [quick-brown-bot/hexapod_v2](https://github.com/quick-brown-bot/hexapod_v2). This repo covers the original ESP32 direct-PWM robot only. V1 is closed: the hardware and firmware here are done and kept for reference and continued use, not further development.
...
hardware/
├── servo_mainboard/   Central ESP32 board driving the servos directly
├── leg/               Leg controller board
├── esp32_connector/   ESP32 carrier / breakout
├── symbols/           Symbol libraries
├── footprints/        Footprint libraries
└── models/            Mechanical models

docs/
├── common/            Docs shared across subsystems (RPC, WiFi, config)
